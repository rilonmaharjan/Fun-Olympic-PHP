            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="card-footer">
                  <a href="{{ url('/admin/profilechange') }}"><button type="submit" class="btn btn-info">Edit</button></a>
                 <a href="{{ route('change.password') }}"><button type="submit" class="btn btn-success">Change Password</button></a>
                </div>
