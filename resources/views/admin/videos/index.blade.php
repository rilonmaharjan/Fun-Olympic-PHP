...
<a href="{{ route('videos.index') }}"><strong>{{ session()->get('warn') }} !! click here to delete blogs</strong></a>
    ...
    <button type="button" class="btn btn-default" style="" disabled>
                <h5>List of Videos</h5></button>

               <a href="{{ route('videos.create') }}"><button type="button" class="btn btn-success" style="float:right">
               Add Videos</button></a>
             ...
             @foreach(App\Models\Video::all() as $video)
                <tr>
                  <td>{{ $i++ }}</td>
                    ...
                    <td>
                    <a href="{{ route('videos.show',$video->id) }}"><button type="button" class="btn btn-success btn-sm">View</button></a>
                    <a href="{{ route('videos.edit',$video->id) }}"><button type="button" class="btn btn-info btn-sm">
