        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="fs-logo">
                    ...
                    <p class="text-white">
                        The City of Bayjing won the bid to host FunOlympic Games 2022. This platform is the project to broadcast the games and reach all its audience all over the world.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-5 ">
                <div class="fs-widget">
                    <h4 style="color:teal">Useful Links</h4>
                    <ul class="fw-links">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="fs-widget">
                    <div class="fs-logo">
                        <h4 style="color:teal">Contact</h4>
                        <ul>
                            <li><i class="fa fa-envelope"></i> bayjing@funolympics.com</li>
                            <li><i class="fa fa-phone"></i> +977 9861323432</li>
        ...
        <div class="copyright-option">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="co-text">
                        <p class="text-center" style = "color : #eeeeee">Copyright &copy;2022</script> All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
